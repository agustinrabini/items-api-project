...
import (
	...
	mockdeppkg "github.com/agustinrabini/items-api-project/src/tests/internal/api/dependencies"
	"github.com/agustinrabini/items-api-project/src/tests/internal/domain/mocks"
	"github.com/agustinrabini/items-api-project/src/tests/internal/setup"
...
func TestRepository_Save_Internal_Server_Error(t *testing.T) {
	...
	mock.Run("InternalServerError", func(mock *mtest.T) {
		...
		assert.EqualValues(mock, fmt.Sprintf(repositories.CategoriesDatabaseError, "Save"), err.Message())
...
func TestRepository_GetAll_Internal_Server_Error(t *testing.T) {
	...
	mock.Run("InternalServerError", func(mock *mtest.T) {
		...
		assert.EqualValues(mock, []models.Category(nil), categories)
		assert.EqualValues(mock, "internal_server_error", err.Code())
		assert.EqualValues(mock, fmt.Sprintf(repositories.CategoriesDatabaseError, "GetAll"), err.Message())
		assert.EqualValues(mock, http.StatusInternalServerError, err.Status())
	})
}
...
func TestRepository_GetAll_Bad_Parse_Error(t *testing.T) {
	...
	mock.Run("BadParseError", func(mock *mtest.T) {
		...
		assert.EqualValues(mock, fmt.Sprintf(repositories.CategoriesDatabaseError, "GetAll"), err.Message())
		assert.EqualValues(mock, http.StatusInternalServerError, err.Status())
		assert.EqualValues(mock, "no responses remaining", err.Cause()[0])
	})
}
...
func TestRepository_Get_Error_With_No_Prices(t *testing.T) {
	...
	assert.EqualValues(t, "categories not found", err.Message())
...
func TestRepository_Get_Internal_Server_Error(t *testing.T) {
	...
	mock.Run("InternalServerError", func(mock *mtest.T) {
		...
		assert.EqualValues(t, models.Category{}, category)
		assert.EqualValues(mock, "internal_server_error", err.Code())
		assert.EqualValues(mock, fmt.Sprintf(repositories.CategoriesDatabaseError, "Get"), err.Message())
		assert.EqualValues(mock, http.StatusInternalServerError, err.Status())
	})
}
...
func TestRepository_Update_Not_Found_Error(t *testing.T) {
	...
	assert.EqualValues(t, -1, result)
	assert.EqualValues(t, "not_found", err.Code())
	assert.EqualValues(t, fmt.Sprintf(repositories.CategoriesDatabaseError, "Update"), err.Message())
	assert.EqualValues(t, http.StatusNotFound, err.Status())
}
...
func TestRepository_Update_Invalid_Id_Error(t *testing.T) {
	...
	assert.EqualValues(t, "the provided hex string is not a valid ObjectID", err.Cause()[0])
}
...
func TestRepository_Update_Internal_Server_Error(t *testing.T) {
	...
	mock.Run("InternalServerError", func(mock *mtest.T) {
		...
		assert.EqualValues(mock, "internal_server_error", err.Code())
		assert.EqualValues(mock, fmt.Sprintf(repositories.CategoriesDatabaseError, "Update"), err.Message())
		assert.EqualValues(mock, http.StatusInternalServerError, err.Status())
	})
}
...
func TestRepository_Delete_Not_Found_Error(t *testing.T) {
	...
	assert.EqualValues(t, -1, result)
	assert.EqualValues(t, "not_found", err.Code())
	assert.EqualValues(t, fmt.Sprintf(repositories.CategoriesDatabaseError, "Delete"), err.Message())
	assert.EqualValues(t, http.StatusNotFound, err.Status())
}
...
func TestRepository_Delete_Internal_Server_Error(t *testing.T) {
	...
	mock.Run("InternalServerError", func(mock *mtest.T) {
		...
		assert.EqualValues(mock, -1, result)
		assert.EqualValues(mock, "internal_server_error", err.Code())
		assert.EqualValues(mock, fmt.Sprintf(repositories.CategoriesDatabaseError, "Delete"), err.Message())
		assert.EqualValues(mock, http.StatusInternalServerError, err.Status())
	})
}
